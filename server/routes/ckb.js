  ...
  try {
    ...
    await query(
      `INSERT INTO ckb_search_logs (company_id, user_id, query, results_count, search_type, response_time_ms)
       VALUES ($1, $2, $3, $4, $5, $6)`,
      [company_id, req.user.id, query, searchResults.length, 'semantic', 0] // TODO: Add response time
    );
...
router.post('/qa', async (req, res) => {
  try {
    ...
    const searchResults = await searchDocumentsInternal(companyId, {
      query: question,
      limit: 5
    });
    ...
    await query(
      `INSERT INTO ckb_search_logs (company_id, user_id, query, results_count, search_type, response_time_ms)
       VALUES ($1, $2, $3, $4, $5, $6)`,
      [company_id, req.user.id, question, searchResults.length, 'qa', 0] // TODO: Add response time
    );
