-- Migration: Fix ensure_default_organization_safe function
...
BEGIN
    ...
    INNER JOIN user_mappings um ON uo.user_id = um.internal_user_id
    ...
    -- Get user email from users table via user_mappings
    SELECT u.email INTO user_email
    FROM users u
    INNER JOIN user_mappings um ON u.id = um.internal_user_id
    WHERE um.external_user_id = ensure_default_organization_safe.external_user_id;
