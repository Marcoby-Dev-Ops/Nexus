#!/usr/bin/env node
// server/scripts/delete-empty-conversations.js
// Usage:
//   node server/scripts/delete-empty-conversations.js --dry-run
//   node server/scripts/delete-empty-conversations.js --confirm --days=7 --userId=<user-id>
