...
- **Legacy Docs**: [QUANTUM_BUSINESS_MODEL_IMPLEMENTATION.md](file:///home/vonj/dev/Nexus/docs/implementation/QUANTUM_BUSINESS_MODEL_IMPLEMENTATION.md) describes this as a "universal schema" that is not currently active.

### `identities`
- **Reason**: 0 rows on production. Superseded by `user_profiles`.
- **Legacy Docs**: [FOUNDATION_FIELD_MAPPING.md](file:///home/vonj/dev/Nexus/docs/FOUNDATION_FIELD_MAPPING.md) maps this to the `CompanyFoundation` interface.
...
- **Reason**: 0 rows. 
- **Legacy Docs**: [ORGANIZATION_CONSOLIDATION.md](file:///home/vonj/dev/Nexus/docs/ORGANIZATION_CONSOLIDATION.md) (Jan 2025) claims this consolidation was completed, but the tables remain empty in favor of `user_profiles` and legacy `companies`.
