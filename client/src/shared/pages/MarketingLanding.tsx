...
// framer-motion removed (not used here)
...
const MarketingLanding: React.FC = () => {
  ...
  const handleTryDemo = async () => {
    // Use the demo manager account by default
    const email = 'admin@nexus-demo.com';
    ...
    if (!result.error) {
      ...
      // If demo auth failed, open the placeholder modal
      setShowDemo(true);
    }
  };
  ...
  // stats intentionally omitted (unused in current design)
    ...
    <div className="bg-background text-foreground">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row items-stretch min-h-[480px] md:min-h-[600px] lg:min-h-[700px] w-full">
          ...
          <div className="flex-1 flex flex-col justify-center px-6 py-12 md:py-0 md:pl-12 md:pr-8 z-10 bg-background/90">
            ...
            <Button size="lg" variant="outline" className="ml-4 text-lg px-8 py-4" onClick={handleTryDemo}>
              Try Demo
            </Button>
        ...
        <div className="py-24 text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
              ...
              <Button size="lg" variant="ghost" onClick={handleTryDemo} className="text-lg px-8 py-4">
                Try Demo
              </Button>
      ...
      {showDemo && (
        <div
          ...
          aria-hidden="false"
        >
          <div className="bg-background rounded-lg p-8 max-w-md w-full" role="dialog" aria-modal="true" aria-label="Demo modal">
