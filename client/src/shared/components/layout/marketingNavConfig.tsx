...
export const marketingNavItems: MarketingNavItem[] = [
  // === FEATURES & CAPABILITIES ===
  {
    ...
    children: [
      ...
      {
        name: 'Purposeful Experience',
        path: '/experience/purposeful',
        description: 'See how every screen serves the vision'
      },
      {
        name: 'Transformation Framework',
        path: '/experience/purposeful#framework',
        description: '4-phase journey from novice to expert'
      },
      {
