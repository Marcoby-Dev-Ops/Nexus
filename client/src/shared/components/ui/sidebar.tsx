      ...
      <SidebarContext.Provider value={contextValue}>
        <TooltipProvider delayDuration={0}>
          <div
            ...
            className={cn(
              "group/sidebar-wrapper flex min-h-svh w-full has-data-[collapsible=icon]:sidebar-width-icon",
              className
            )}
            ref={ref}
            {...props}
  ...
  (
    ...
    return (
      <div
        ...
        data-side={side}
      >
        {/* No spacer div - sidebar overlays content instead of pushing it */}
        <div
          className={cn(
...
const SidebarGroup = React.forwardRef<
  HTMLDivElement,
  React.ComponentProps<"div"> & {
    variant?: "default" | "rounded" | "padded"
  }
  ...
  return (
    <div
      ...
      className={cn(
        ...
        "data-[variant=rounded]:gap-1",
        "data-[variant=padded]:gap-1",
