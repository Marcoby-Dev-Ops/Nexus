...
import { MemoryInspectorWrapper } from '@/components/MemoryInspector';

// Import global styles
import '@/shared/assets/index.css';
// Marcoby Hosting Easy theme overrides (apply after base tokens)
import '@/shared/assets/marcoby-hosting-easy-overrides.css';
      ...
      <ErrorBoundary>
        <Router>
          <ThemeProvider defaultTheme="system">
            <App />
            {/* Dev-only Memory Inspector for semantic memory debugging */}
            {import.meta.env.DEV ? <MemoryInspectorWrapper /> : null}
          </ThemeProvider>
        </Router>
      </ErrorBoundary>
    );
