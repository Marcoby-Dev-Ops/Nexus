...
import { DollarSign, BarChart, LifeBuoy, Gauge, Megaphone, Users, Monitor, Code, Heart, Scale } from 'lucide-react';
...
const ICONMAP: Record<DepartmentId, React.ReactElement<React.SVGProps<SVGSVGElement>>> = {
...
const RAWDEPARTMENTS: Array<{
  ...
  },
  {
    ...
    description: 'Manages employee lifecycle, recruitment, performance, and organizational development',
  },
  {
    id: 'it',
    label: 'Information Technology',
    description: 'Oversees technology infrastructure, security, and technical support services',
  },
  {
    id: 'product',
    label: 'Product & Engineering',
    description: 'Drives product development, technical innovation, and engineering excellence',
  },
  {
    id: 'customer-success',
    label: 'Customer Success',
    description: 'Ensures customer satisfaction, retention, and expansion opportunities',
  },
  {
    id: 'legal',
    label: 'Legal & Compliance',
    description: 'Manages legal affairs, contract negotiations, and regulatory compliance',
  },
];
