      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-primary via-secondary to-primary/80 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center p-12 text-primary-foreground">
          ...
          <div className="space-y-6">
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-indigo-200 text-sm">Get insights that matter with AI-powered business intelligence</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-indigo-200 text-sm">Streamline workflows and eliminate repetitive tasks</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-indigo-200 text-sm">Unite your team with integrated communication tools</p>
              </div>
            </div>
          </div>
          ...
          <div className="mt-12 pt-8 border-t border-white/20">
            <p className="text-indigo-200 text-sm mb-4">Trusted by forward-thinking businesses</p>
            <div className="flex items-center space-x-6 text-xs text-indigo-300">
        ...
        <div className="max-w-md w-full">
          ...
          <div className="mt-6 p-4 bg-primary/5 dark:bg-primary/10 border border-border dark:border-primary/20 rounded-lg">
            <div className="flex items-start space-x-4">
              ...
              <div>
                <p className="text-sm font-medium text-primary dark:text-blue-300 mb-1">
                  Quick Setup Process
                </p>
