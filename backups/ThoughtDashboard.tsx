...
const CATEGORY_CONFIG = {
  idea: { icon: Lightbulb, label: 'Ideas', color: 'bg-yellow-100 text-yellow-800' },
  task: { icon: CheckSquare, label: 'Tasks', color: 'bg-blue-100 text-blue-800' },
  reminder: { icon: Bell, label: 'Reminders', color: 'bg-purple-100 text-purple-800' },
  update: { icon: TrendingUp, label: 'Updates', color: 'bg-green-100 text-green-800' }
};

const STATUS_CONFIG = {
  future_goals: { label: 'Future Goals', color: 'bg-gray-100 text-gray-800' },
  concept: { label: 'Concept', color: 'bg-yellow-100 text-yellow-800' },
  ...
  due: { label: 'Due', color: 'bg-red-100 text-red-800' },
  overdue: { label: 'Overdue', color: 'bg-red-200 text-red-900' }
};
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="text-center">
              <div className="relative mx-auto w-24 h-24 bg-yellow-100 rounded-full flex items-center justify-center mb-4">
            ...
            {/* Reminders Circle */}
            <div className="text-center">
              <div className="relative mx-auto w-24 h-24 bg-purple-100 rounded-full flex items-center justify-center mb-4">
