                    ...
                    <div className="space-y-4">
                      ...
                      <div>
                        ...
                        <div className="w-full bg-gray-200 rounded-full h-3 relative overflow-hidden">
                          ...
                          />
                          <div 
                            className="bg-green-400 h-3 absolute top-0 transition-all duration-1000" 
                            style={{ 
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="p-4 bg-secondary/5 border border-purple-200 rounded-lg">
                      <h4 className="font-semibold text-purple-800 mb-2">Business Impact</h4>
                      <p className="text-sm text-purple-700">{selectedCapability.businessImpact}</p>
                    </div>
                    
                    <div className="p-4 bg-orange-50 border border-orange-200 rounded-lg">
                      <h4 className="font-semibold text-orange-800 mb-2">Untapped Potential</h4>
