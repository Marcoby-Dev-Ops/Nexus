...
/*
 ...
 Usage:
  DATABASE_URL=postgres://... node scripts/normalize-industry.js --dry-run
  DATABASE_URL=postgres://... node scripts/normalize-industry.js --apply
*/
...
function usageAndExit() {
  console.log('Usage: DATABASE_URL=... node scripts/normalize-industry.js [--dry-run|--apply]')
  process.exit(1)
}
