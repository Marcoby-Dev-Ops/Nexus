...
export class GoogleAnalyticsService extends BaseService {
  ...
  async getValidTokens(userId: string): Promise<ServiceResponse<GoogleAnalyticsTokens>> {
    try {
      ...
      const response = await retryFetch(`${import.meta.env.VITE_SUPABASE_URL}/functions/v1/google-analytics-get-tokens`, {
        method: 'POST',
        headers: {
  ...
  async refreshTokens(userId: string, refreshToken: string): Promise<ServiceResponse<GoogleAnalyticsTokens>> {
    try {
      ...
      const response = await retryFetch(`${import.meta.env.VITE_SUPABASE_URL}/functions/v1/google-analytics-refresh-tokens`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${session.access_token}`
  ...
  async hasValidConnection(userId: string): Promise<ServiceResponse<boolean>> {
    try {
      ...
      const response = await retryFetch(`${import.meta.env.VITE_SUPABASE_URL}/functions/v1/google-analytics-test-connection`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${session.access_token}`
  ...
  async getConnectionStatus(userId: string): Promise<ServiceResponse<{
    ...
    try {
      ...
      const response = await retryFetch(`${import.meta.env.VITE_SUPABASE_URL}/functions/v1/google-analytics-connection-status`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${session.access_token}`
  ...
  async syncGoogleAnalyticsDataWithIntelligence(userId: string): Promise<ServiceResponse<{
    ...
    try {
      ...
      const response = await retryFetch(`${import.meta.env.VITE_SUPABASE_URL}/functions/v1/google-analytics-sync`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${session.access_token}`
  ...
  async getGoogleAnalyticsData(userId: string): Promise<ServiceResponse<GoogleAnalyticsIntegrationData>> {
    try {
      ...
      const response = await retryFetch(`${import.meta.env.VITE_SUPABASE_URL}/functions/v1/google-analytics-get-data`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${session.access_token}`
  ...
  async disconnectIntegration(userId: string): Promise<ServiceResponse<boolean>> {
    try {
      ...
      const response = await retryFetch(`${import.meta.env.VITE_SUPABASE_URL}/functions/v1/google-analytics-disconnect`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${session.access_token}`
