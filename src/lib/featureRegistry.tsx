...
const features: FeatureDefinition[] = [
  ...
  // Productivity Features
  {
    ...
    accessLevel: 'free',
    keywords: ['calendar', 'schedule', 'meetings', 'appointments'],
    relatedFeatures: ['tasks', 'team-management'],
  },
  {
    id: 'messages',
    name: 'Messages',
  ...
  },
  {
    ...
    relatedFeatures: ['calendar', 'team-management'],
  },
...
export const getFeaturesByAccessLevel = (level: FeatureAccessLevel): FeatureDefinition[] => {
  return features.filter(feature => feature.accessLevel === level);
};
...
export const getRelatedFeatures = (featureId: string): FeatureDefinition[] => {
  ...
  return features.filter(f => feature.relatedFeatures?.includes(f.id));
};
