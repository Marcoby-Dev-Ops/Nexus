    ...
    <div className="p-8 space-y-8">
      ...
      <div className="rounded-xl border p-4">
        ...
        <ul className="list-disc pl-5">
          <li>Branding: <span className="text-muted-foreground">Nexus OS</span></li>
          <li>Integrations: <span className="text-muted-foreground">QuickBooks, Slack</span></li>
          <li>Preferences: <span className="text-muted-foreground">Dark mode enabled</span></li>
        </ul>
      </div>
          ...
          <ul className="divide-y">
            {activityLog.map((a, i) => (
              <li key={i} className="py-2">
                {a.action} by <span className="font-medium">{a.who}</span> <span className="text-xs text-muted-foreground">({a.date})</span>
              </li>
            ))}
          </ul>
        </div>
