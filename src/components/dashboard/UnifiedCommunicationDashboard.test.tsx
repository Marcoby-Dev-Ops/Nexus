...
import { communicationAnalyticsService } from '@/lib/services/communicationAnalyticsService';

// Mock the service
jest.mock('@/lib/services/communicationAnalyticsService');
...
describe('UnifiedCommunicationDashboard', () => {
  ...
  it('auto-refreshes data at intervals', async () => {
    ...
    await waitFor(() => {
      expect(communicationAnalytics.getUnifiedInsights).toHaveBeenCalledTimes(2);
    });
  });
}); 