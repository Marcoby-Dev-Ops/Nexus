...
import { profileContextService, type RAGProfileContext, type ProfileContextUpdate } from '@/lib/services/profileContextService';
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Textarea
                      ...
                      placeholder="e.g., Salesforce, HubSpot, Slack, Microsoft 365"
                      rows={2}
                    />
              ...
              <div className="flex items-center justify-between pt-6 border-t">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <Button onClick={handleSave} disabled={saving}>
                    {saving ? (
                      <>
                        <LoadingStates.ButtonSpinner /></div>
                        Saving...
                      </>
                    ) : (
                      <>
