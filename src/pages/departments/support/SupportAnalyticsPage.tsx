...
import { LifeBuoy, RefreshCw, CheckCircle2, AlertCircle, Clock, Activity, Lightbulb, Zap, TrendingUp, Brain } from 'lucide-react';
...
const SystemSupportCards: React.FC = () => {
  ...
  return (
    <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-4 mb-8">
      ...
      <Card className="flex flex-col">
        ...
        <CardContent className="flex-1 flex flex-col justify-between">
          <div className="space-y-2 mb-4">
            <Button variant="secondary" size="sm" className="w-full" onClick={() => window.location.href = '/support/analytics'}>
              View Support Analytics
            </Button>
            <Button variant="secondary" size="sm" className="w-full" onClick={() => window.location.href = '/support/tickets'}>
              View Tickets
            </Button>
            <Button variant="secondary" size="sm" className="w-full" onClick={() => window.location.href = '/ai-hub'}>
              Ask AI for Support Insight
            </Button>
          </div>
        </CardContent>
      </Card>
