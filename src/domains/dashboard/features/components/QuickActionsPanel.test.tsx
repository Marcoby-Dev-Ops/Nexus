...
import { QuickActionsPanel } from '@/domains/dashboard/features/components/QuickActionsPanel';
import * as QAP from '@/domains/dashboard/features/components/QuickActionsPanel';
