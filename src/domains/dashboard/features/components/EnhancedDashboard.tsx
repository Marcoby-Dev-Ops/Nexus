...
const SecurityDashboard = lazy(() => import('@/shared/shared/components/dashboard/SecurityDashboard').then(module => ({ default: module.SecurityDashboard })));
const VARLeadDashboard = lazy(() => import('@/shared/shared/components/dashboard/VARLeadDashboard').then(module => ({ default: module.VARLeadDashboard })));
const ModelManagementDashboard = lazy(() => import('@/shared/shared/components/dashboard/ModelManagementDashboard').then(module => ({ default: module.ModelManagementDashboard })));
const CentralizedAppsHub = lazy(() => import('@/shared/shared/components/dashboard/CentralizedAppsHub').then(module => ({ default: module.CentralizedAppsHub })));
