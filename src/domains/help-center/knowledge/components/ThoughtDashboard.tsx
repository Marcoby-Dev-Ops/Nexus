...
import { Plus, Brain, Lightbulb, BookOpen, Clock, TrendingUp, ArrowRight, BarChart3, Target } from 'lucide-react';
import { thoughtsService } from '@/shared/features/knowledge/lib/services/thoughtsService';
import { useAuth } from '@/core/auth/AuthProvider';
import { supabase } from '@/core/supabase';
import { logger } from '@/core/auth/logger';
import { InteractivePrompts } from '@/shared/ai/features/components/InteractivePrompts';
import type { Thought, ThoughtCategory, ThoughtMetrics, CreateThoughtRequest, UpdateThoughtRequest } from '@/shared/types/thoughts';
...
const STATUS_CONFIG = {
  futuregoals: { label: 'Future Goals', color: 'bg-muted text-foreground' },
  concept: { label: 'Concept', color: 'bg-warning/10 text-warning-foreground' },
  inprogress: { label: 'In Progress', color: 'bg-primary/10 text-primary' },
  ...
  notstarted: { label: 'Not Started', color: 'bg-muted text-foreground' },
