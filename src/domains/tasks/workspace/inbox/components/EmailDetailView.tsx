...
import type { OWAEmailItem } from '@/domains/email/services/owaInboxService';
    ...
    <Card className="flex flex-col h-full shadow-lg">
      ...
      <CardContent className="p-0 flex-1 overflow-y-auto">
        ...
        <div 
          ...
          dangerouslySetInnerHTML={{ html: item.html_content || item.content || '<p>No content available.</p>' }}
        />
      </CardContent>
    </Card>
  );
