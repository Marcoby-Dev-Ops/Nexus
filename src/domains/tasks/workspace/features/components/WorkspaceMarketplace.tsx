...
import { Search, Star, Download, Heart, Eye, Filter, Grid, List, TrendingUp, Clock, Users, Copy, Sparkles, Crown, Zap, Target, Briefcase, Code, PieChart, Shield, Palette, Layout, ThumbsUp } from 'lucide-react';
...
const MOCKMARKETPLACEWORKSPACES: MarketplaceWorkspace[] = [
  {
