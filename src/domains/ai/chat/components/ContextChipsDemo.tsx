  ...
  createMockContextSources: () => [
    {
      id: '1',
      type: 'business-data',
      name: 'Q3 Performance Metrics',
      description: 'Revenue and customer data from Q3 2024',
      confidence: 0.95,
    ...
    },
    {
      ...
      description: 'Strategic planning document for Q4 2024',
      confidence: 0.88,
    ...
    },
    {
      ...
      type: 'integration',
      name: 'HubSpot CRM',
      description: 'Sales pipeline data from HubSpot',
      confidence: 0.92,
