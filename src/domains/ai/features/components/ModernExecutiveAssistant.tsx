...
import { VirtualizedMessageList } from '@/domains/ai/features/components/enhanced/VirtualizedMessageList';
...
import { ActionCard } from '@/domains/ai/features/components/ActionCard';
import { useActionCards } from '@/domains/hooks/useActionCards';
import { ContextChips } from '@/domains/ai/components/ContextChips';
...
import { useContextualDataCompletion } from '@/domains/ai/features/hooks/useContextualDataCompletion';
...
type MessageType = import('@/shared/shared/stores/useAIChatStore').AIMessage;
