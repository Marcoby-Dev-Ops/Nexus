...
import { ExecutiveAssistantWidget } from '@/domains/ai/features/components/QuickChat';
...
export const QuickChatTrigger: React.FC<QuickChatTriggerProps> = ({
  ...
  useEffect(() => {
    ...
    window.addEventListener('open-executive-assistant', handler);
    return () => window.removeEventListener('open-executive-assistant', handler);
  }, []);
