...
import { ModernExecutiveAssistant } from '@/domains/ai/features/components/ModernExecutiveAssistant';
import { DepartmentalAgent } from '@/domains/ai/features/components/DepartmentalAgent';
