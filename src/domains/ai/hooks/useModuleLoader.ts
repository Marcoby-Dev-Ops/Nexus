...
import { initializeModule, initializeModules, getAvailableModuleIds, isModuleAvailable } from '@/domains/ai/lib/modules/moduleRegistry';
import type { ModuleMetadata } from '@/domains/ai/lib/modules/moduleRegistry';
