        ...
        <div className="relative z-10 flex flex-col justify-center p-8 text-primary-foreground">
          <div className="mb-8">
            ...
            <p className="text-xl text-primary-foreground/80 mb-8">
              Access your AI-powered business operating system and continue transforming your operations.
            </p>
          </div>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground dark:text-muted-foreground">
                  Your account is protected with enterprise-grade security. Use passkeys for the most secure login experience.
                </p>
              </div>
            </div>
          </div>
