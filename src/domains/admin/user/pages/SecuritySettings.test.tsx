...
import SecuritySettings from '@/domains/admin/user/pages/settings/SecuritySettings';
import * as passkeyUtils from '@/shared/utils/passkey';
...
jest.mock('@shared/shared/utils/passkey');
