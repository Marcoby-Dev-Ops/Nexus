...
import type { StorageProvider, KnowledgeDocumentMeta, DocumentDomain } from '@/services/ZeroRetentionStorageService';
import { ZeroRetentionStorageService } from '@/services/ZeroRetentionStorageService';
...
export const ZeroRetentionDocumentManager: React.FC<ZeroRetentionDocumentManagerProps> = ({
  ...
  const [complianceStatus, setComplianceStatus] = useState<'active' | 'expired' | 'pending_renewal'>('active');

  // Initialize zero-retention storage service
  const storageService = new ZeroRetentionStorageService({
