...
INSERT INTO billing_plans (id, name, description, price_monthly, price_yearly, features, token_limit, is_popular) VALUES
('free', 'Free Plan', 'Basic features for individuals', 0, 0, '["Basic AI chat", "Limited models", "Community support"]', 10000, false),
('pro', 'Pro Plan', 'Advanced features for professionals', 29.99, 299.99, '["Advanced AI chat", "All models", "Priority support", "Analytics dashboard"]', 100000, true),
('enterprise', 'Enterprise Plan', 'Full features for teams', 99.99, 999.99, '["Enterprise AI chat", "All models", "Dedicated support", "Advanced analytics", "Custom integrations"]', 500000, false)
