...
DROP TRIGGER IF EXISTS update_ai_action_cards_updated_at ON public.ai_action_cards;
...
DROP TRIGGER IF EXISTS update_ai_action_card_events_updated_at ON public.ai_action_card_events;
...
DROP TRIGGER IF EXISTS update_ai_vector_documents_updated_at ON public.ai_vector_documents;
...
DROP POLICY IF EXISTS "Authenticated users can view AI vector documents" ON public.ai_vector_documents;
...
DROP POLICY IF EXISTS "Service role can insert AI audit logs" ON public.ai_audit_logs;
CREATE POLICY "Service role can insert AI audit logs" ON public.ai_audit_logs
    FOR INSERT WITH CHECK (true);
DROP POLICY IF EXISTS "No users can select AI audit logs" ON public.ai_audit_logs;
