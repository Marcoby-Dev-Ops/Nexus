...
const assessmentQuestions = [
  // Foundations
  { id: 'FD-01', category_id: 'FD', prompt: 'What is your company website?', question_type: 'text', integration_check: 'manual', marcovy_angle: 'Core company profile', action_type: 'UPDATE_PROFILE', target_field: 'website' },
  { id: 'FD-02', category_id: 'FD', prompt: 'When was the company founded?', question_type: 'date', integration_check: 'manual', marcovy_angle: 'Core company profile', action_type: 'UPDATE_PROFILE', target_field: 'founded' },
  { id: 'FD-03', category_id: 'FD', prompt: 'Provide a short description of your company.', question_type: 'text', integration_check: 'manual', marcovy_angle: 'Core company profile', action_type: 'UPDATE_PROFILE', target_field: 'description' },
  { id: 'FD-04', category_id: 'FD', prompt: 'What is your Dun & Bradstreet number (if any)?', question_type: 'text', integration_check: 'manual', marcovy_angle: 'Business credit and identity', action_type: 'UPDATE_PROFILE', target_field: 'duns_number' },
  { id: 'FD-05', category_id: 'FD', prompt: 'What is your main business phone number?', question_type: 'text', integration_check: 'manual', marcovy_angle: 'Contact and identity', action_type: 'UPDATE_PROFILE', target_field: 'business_phone' },
  { id: 'FD-06', category_id: 'FD', prompt: 'What system do you use for inventory management?', question_type: 'text', integration_check: 'manual', marcovy_angle: 'Operational maturity', action_type: 'UPDATE_PROFILE', target_field: 'inventory_management_system' },
  { id: 'FD-07', category_id: 'FD', prompt: 'Briefly describe your primary client base.', question_type: 'text', integration_check: 'manual', marcovy_angle: 'Market positioning', action_type: 'UPDATE_PROFILE', target_field: 'client_base_description' },
  
  // Sales
  { id: 'SA-01', category_id: 'SA', prompt: 'Do you track deals in a CRM?', question_type: 'bool', integration_check: 'HubSpot/Salesforce API', marcovy_angle: 'Pulse – CRM setup', offer_slug: 'crm-setup', action_type: 'SCORE', target_field: null },
  ...
  // Operations
  { id: 'OP-01', category_id: 'OP', prompt: '% of repeatable tasks automated', question_type: 'number', integration_check: 'n8n run stats', marcovy_angle: 'Nexus – Workflow library', offer_slug: 'workflow-library', action_type: 'SCORE', target_field: null },
  { id: 'OP-02', category_id: 'OP', prompt: 'Avg. project on-time delivery (%)', question_type: 'number', integration_check: 'Asana / Jira', marcovy_angle: 'Catalyst – PMO advisory', offer_slug: 'pmo-advisory', action_type: 'SCORE', target_field: null },
  { id: 'OP-03', category_id: 'OP', prompt: 'Utilization rate (hrs billed ÷ capacity)', question_type: 'number', integration_check: 'Harvest / Tempo', marcovy_angle: 'Pulse – Resource planning', offer_slug: 'resource-planning', action_type: 'SCORE', target_field: null },
];
